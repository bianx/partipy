...
vofi_real EXPORT(vofi_get_fh) (integrand impl_func, vofi_creal x0[],
                               vofi_creal * H0, vofi_cint * Ndim0,
                               vofi_cint * iX0) {
    vofi_creal h0 = *H0;
...
vofi_real EXPORT(vofi_get_cc) (integrand impl_func, vofi_creal x0[],
                               vofi_creal * H0, vofi_creal * Fh,
                               vofi_cint * Ndim0) {
