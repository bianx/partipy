...
int
vofi_check_side_consistency(integrand impl_func, vofi_creal fe[],
                            vofi_creal x0[], vofi_creal sidedir[],
                            vofi_creal h0)
{
    int i, f_iat, ftmp;
...
chk_data
vofi_check_face_consistency(integrand impl_func, vofi_creal fv[],
                            vofi_creal x0[], vofi_creal sdir[],
